...
function atualizarRecibo() {
    ...
    detalhesRecibo.innerHTML = 'Afiliado: Atendado Napalm'; // Limpa o conteúdo anterior
...
function confirmarPedido() {
    ...
    let mensagem = 'Afiliado: Atendado \n';
...
function redirecionar() {
    window.location.href = "atentado.html"; // Substitua pelo URL desejado
}